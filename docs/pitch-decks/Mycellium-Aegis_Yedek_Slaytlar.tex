...
\begin{frame}{\"U\c{c} katmanl{\i} biyomimetik k\"ok-elektrot}{Problar / Elektrot}
  \begin{columns}[T]
    \column{0.45\textwidth}
      \begin{center}
        \includegraphics[width=0.92\textwidth]{electrode_cross_section.pdf}
      \end{center}
...
\begin{frame}{Ham gerilimden karara: u\c{c}ta i\c{s}lenen f\"uzyon hatt{\i}}{Yapay Zeka / Sinyal \.I\c{s}leme}
  \begin{center}
    \includegraphics[width=0.88\textwidth]{ai_pipeline.pdf}
  \end{center}
  \vskip4pt
  \begin{columns}[T]
...
\begin{frame}{Her riskin bir B plan{\i} var}{Risk Y\"onetimi}
  ...
  \vskip8pt
  \begin{center}
    \includegraphics[width=0.42\textwidth]{roc.pdf}
    \hfill
    \includegraphics[width=0.42\textwidth]{fusion_separability.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Yap{\i}y zeka sistemi --- Detayl{\i} Soru-Cevap}{YZ Derinle\c{s}tirme}
  ...
  \begin{columns}[T]
    \column{0.48\textwidth}
      ...
      \vskip4pt
      {\color{ember}\texttt{S:}} {\color{sage}UÃ§ta (edge) m{\i} bulutta m{\i}?}\par
      {\color{spore} Ã–n i\c{s}leme (FIR, \"oznitelik) ve AND-gate kesinlikle u\c{c}ta (ESP32). LSTM \c{c}{\i}kar{\i}m{\i}: u\c{c}ta TinyML (TFLite Micro). Bulut: retrain + SaaS pano.}\par
      \vskip4pt
...
\begin{frame}{Finansal \"ong\"or\"u --- ba\c{s}a ba\c{s} analizi}{Finans}
  \begin{center}
    \includegraphics[width=0.62\textwidth]{breakeven.pdf}
  \end{center}
  \vskip4pt
  {\footnotesize\color{sage}
